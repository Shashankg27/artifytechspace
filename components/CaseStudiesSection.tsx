    ...
    <section className="relative min-h-screen flex items-center py-32 overflow-hidden bg-black">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-end justify-between mb-24 gap-8">
          ...
          >
            <MagneticButton>
              <button className="px-10 py-4 rounded-full border border-white/20 text-white font-black text-[10px] uppercase tracking-widest hover:bg-white hover:text-black transition-all">
                View All Projects
              </button>
            </MagneticButton>
          </motion.div>
